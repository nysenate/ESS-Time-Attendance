 ...
 */
public interface NewEmpTransactionDao
{
     ...
     *
     * @see #getTransHistory(int, java.util.Set, TransDaoOption)
     */
     ...
     *
     * @see #getTransHistory(int, java.util.Set, com.google.common.collect.Range, TransDaoOption)
     */
