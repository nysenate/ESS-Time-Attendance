...
<section ng-controller="EmpTransactionHistoryCtrl">
    <div class="content-container content-controls grid">
        <div class="col-1-2">
            <p class="no-bottom-margin content-info">Show Transactions for Year &nbsp;
        ...
        <div class="col-1-2">
            <p class="no-bottom-margin content-info">Filter By Transaction Type &nbsp;
