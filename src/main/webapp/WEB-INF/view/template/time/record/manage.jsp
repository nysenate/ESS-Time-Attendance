...
<section class="content-container">
  ...
  <table class="ess-table approve-attendance-rec-table">
    ...
    <tr>
      <td><input type="checkbox"/></td>
      <td>
        <div style="background:url('https://avatars0.githubusercontent.com/u/330720?s=30')"
             class="small-employee-profile-pic">&nbsp;</div>
      </td>
    ...
    <tr>
      <td><input type="checkbox"/></td>
      <td>
        <div style="background:url('https://avatars2.githubusercontent.com/u/94740?s=30')"
             class="small-employee-profile-pic">&nbsp;</div>
      </td>
...
<section id="review-records-modal" class="" title="Review and Approve Records">
  ...
  <div id="record-selection-pane">
    ...
    <table id="record-selection-table" class="ess-table approve-attendance-rec-table">
      ...
      <tr class="active">
        <td>
          <div style="background:url('https://avatars0.githubusercontent.com/u/2687188?s=30')"
               class="small-employee-profile-pic">&nbsp;</div>
        </td>
  ...
  <div id="record-details-view">
    ...
    <div>
      ...
      <div id="action-container">
        <input onclick="$('#rejection-dialog').dialog('open');" class="reject-button" type="button"
               value="Disapprove Record"/>
        <input class="submit-button" type="button" value="Approve Record"/>
        <input style="float:right;" onclick="$('#review-records-modal').dialog('close');" class="neutral-button"
...
<section id="rejection-dialog" title="Reject Time Record">
  ...
  <div style="padding:.4em;background:#eee;text-align: center;">
    ...
    <input style="float:right;" onclick="$('#rejection-dialog').dialog('close');" class="neutral-button" type="button"
           value="Cancel"/>
  </div>
</section>
